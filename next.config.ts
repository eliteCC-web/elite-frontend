      ...
      return [
        {
          ...
          headers: [
            ...
            },
            {
              ...
              value: "default-src 'self'; script-src 'self' 'unsafe-eval' 'unsafe-inline' https://maps.googleapis.com https://maps.gstatic.com; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com; font-src 'self' https://fonts.gstatic.com https://fonts.googleapis.com; img-src 'self' data: https: http: https://maps.googleapis.com https://maps.gstatic.com; connect-src 'self' https: wss: https://maps.googleapis.com; frame-src 'self' https://www.google.com https://maps.googleapis.com https://cloud8.vsgtech.co; media-src 'self' https://pmulriauzstmyeslfvpn.supabase.co; object-src 'none'; base-uri 'self'; form-action 'self';"
            },
            {
