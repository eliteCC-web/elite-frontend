...
// Eventos relacionados (función para obtener 3 eventos relacionados por categoría)
function getEventosRelacionados(slug: string, categorias: string[]) {
  return eventosData
    .filter((evento) => evento.slug !== slug && evento.categorias.some((cat) => categorias.includes(cat)))
    .slice(0, 3)
}
...
export default function EventoDetallePage({ params }: { params: { slug: string } }) {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <Link
            href="/eventos"
            className="inline-flex items-center bg-blue-700 text-white px-6 py-3 rounded-full font-medium hover:bg-blue-800"
          >
  ...
  const eventosRelacionados = getEventosRelacionados(params.slug, evento.categorias)
