...
export default function PendingRegistrationsPage() {
  ...
  const filteredRegistrationHistory = registrationHistory.filter(registration =>
    (registration.firstName.toLowerCase().includes(searchTerm.toLowerCase()) ||
    registration.lastName.toLowerCase().includes(searchTerm.toLowerCase()) ||
    registration.email.toLowerCase().includes(searchTerm.toLowerCase())) &&
    ...
    <>
      {loading ? (
        ...
        <>
          {/* Header */}
          <div className="mb-6">
            <h1 className="text-3xl font-bold text-gray-900 mb-2">Registros Pendientes</h1>
            <p className="text-gray-600">Gestiona las solicitudes de registro de usuarios internos</p>
          </div>
              ...
              registrationHistory.length === 0 ? (
                ...
                <div className="overflow-x-auto">
                  <table className="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody className="bg-white divide-y divide-gray-200">
                      {filteredRegistrationHistory.map((registration) => (
                        <tr key={registration.id} className="hover:bg-gray-50">
                          <td className="px-6 py-4 whitespace-nowrap">
                            <div className="flex items-center">
                              <div className="flex-shrink-0 h-10 w-10">
