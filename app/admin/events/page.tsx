        ...
        <form onSubmit={handleSearch} className="flex flex-col sm:flex-row gap-4">
          ...
          <div className="relative">
            <select
              ...
              className="appearance-none bg-white px-4 py-2 pr-8 border border-gray-200 rounded-md text-sm focus:outline-none focus:ring-1 focus:ring-blue-500"
            >
        ...
        {loading ? (
          ...
          <div className="p-8 text-center">
            <div className="bg-gray-100 rounded-full p-3 w-16 h-16 flex items-center justify-center mx-auto">
              <CalendarIcon size={28} className="text-gray-500" />
            </div>
            <h3 className="mt-3 text-lg font-medium text-gray-800">No hay eventos disponibles</h3>
            <p className="mt-1 text-gray-600">Crea tu primer evento para comenzar</p>
            <div className="mt-4">
              <Link
                href="/admin/events/new"
